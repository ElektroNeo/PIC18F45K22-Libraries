...
# 199 "C:/Program Files/Microchip/MPLABX/v5.50/packs/Microchip/PIC18F-K_DFP/1.4.87/xc8\\pic\\include\\pic18_chip_select.h" 3
...
# 200 "C:/Program Files/Microchip/MPLABX/v5.50/packs/Microchip/PIC18F-K_DFP/1.4.87/xc8\\pic\\include\\pic18_chip_select.h" 2 3
...
void sev_seg_scan(sev_seg_display_t * sev_seg) {
    ...
    (*sev_seg->digit[4 - sev_seg->current_digit - 1].port) &= ~(1 << sev_seg->digit[4 - sev_seg->current_digit - 1].pin);
    ...
    for (uint8_t i = 0, j = 0b01000000; i < 8 - 1; i++, j >>= 1) {
        if (digit_val & j) {
            (*sev_seg->seg[i].port) &= ~(1 << sev_seg->seg[i].pin);
        }
    }
